...
export const PasswordInput = ({
  ...
  return (
    <div className="w-full">
      ...
      <div className="group flex h-14 items-center gap-3 border border-white/10 bg-white/[0.03] px-4 transition-all duration-300 hover:border-white/20 focus-within:border-violet-400/40 focus-within:bg-violet-500/[0.03]" style={{ borderRadius: 16 }}>
        <svg
